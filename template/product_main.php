                ...
                <div class="bg-white p-4 rounded shadow-sm">
                    ...
                    <div class="d-flex flex-column flex-md-row align-items-md-center mb-4">
                        <div class="me-md-4 text-success">
                            <p class="display-4 fw-bold mb-0">45,00</p>
                            <small class="text-muted">(IVA inclusa)</small>
                        </div>
                    </div>
                    <div class="row mb-4">
                        <div class="col-6">
                            <p class="mb-0 text-muted">Codice prodotto: 7438629031182</p>
                        </div>
                        <div class="col-6">
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-bold" for="quantita">Quantità:</label>
                    <input type="number" id="quantita" class="form-control" value="1" style="max-width: 100px;"/>
                    </div>
                    <button class="btn btn-success d-block w-100 mb-3 py-3 shadow-sm hover-scale">
