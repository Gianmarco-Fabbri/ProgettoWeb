...
$filteredProductsCasa = $dbh->getProdottiCasaGreenFiltratiPerPrezzo($minPrice, $maxPrice);

// Se non ci sono prodotti, restituisci un array vuoto
if (!$filteredProductsCasa) {
    $filteredProductsCasa = [];
}

// Restituisci i prodotti filtrati come JSON
echo json_encode($filteredProductsCasa);
?>
